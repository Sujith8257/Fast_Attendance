...
import 'upload_csv_screen.dart'; // Assuming this is the admin screen
import 'user_screen.dart'; // Create this for user functionalities
...
void main() async {
  ...
  runApp(FileSenderApp());
}

class FileSenderApp extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: LoginPage(), // Change back to home instead of initialRoute
      routes: {
